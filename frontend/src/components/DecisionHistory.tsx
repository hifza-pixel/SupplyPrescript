...
import { Decision, getDecisionHistory } from "@/services/decisionService";
            ...
            <table className="w-full text-left text-sm">
                <thead>
                    <tr className="border-b border-[#18334a] text-xs uppercase tracking-wider text-slate-500">
                        ...
                        <th className="px-3 py-3">Predicted Delay</th>
                        <th className="px-3 py-3">Cost</th>
                        <th className="px-3 py-3">Resulting Delay</th>
                ...
                <tr
                  key={decision.id}
                  className="border-b border-[#18334a]/60 hover:bg-white/2"
                >
