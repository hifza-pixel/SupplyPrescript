...
return ( <main className="flex min-h-screen bg-[#07111f] text-[#e6f1ff]">
{/* SIDEBAR */} <aside className="hidden w-64 border-r border-[#18334a] bg-[#091827] p-5 lg:block"> <div className="mb-10 flex items-center gap-3"> <div className="flex h-10 w-10 items-center justify-center rounded-xl bg-cyan-400/10"> <BrainCircuit
...
```
  ...
  <section className="flex-1">
    ...
    <div className="p-6">
      ...
      <div id="explainability" className="mt-6">
        <ModelExplainability />
      </div>

      {/* DECISION ROI */}
      <div id="roi" className="mt-6">
        <DecisionROI />
      </div>
      ...
      <div className="mt-6">
        <div className="mb-5">
          ...
          <p className="mt-1 text-sm text-slate-500">
            Core systems powering SupplyPrescript
          </p>
        </div>
        ...
        <div className="grid gap-4 md:grid-cols-3">
          <TechCard
            title="ML Prediction"
            value="Random Forest"
            detail="Delay classification + duration prediction"
          />
...
return ( 
<div className="rounded-2xl border border-[#18334a] bg-[#0d1d2d] p-5"> <div className="mb-5 flex items-center justify-between"> <p className="text-sm text-slate-400">
{title}
</p>
    <Icon
      size={19}
...
return ( <div className="mb-3 flex items-center justify-between rounded-xl border border-[#18334a] bg-[#091827] p-4"> <div className="flex items-center gap-3"> <Icon
       size={18}
       className="text-cyan-400"
     />
